...
_Except in synthetic community experiments, we are always likely to have taxa not in our controls. We can attempt to use phylogenetic prediction or other modeling of efficiencies to predict the efficiencies of other taxa; however there will be signifciant undertainty. Therefore our control measurements may ideally serve to inform a bias-sensitivity analysis of the sort described below._

For revision:

- Discuss the vaginal mb and leopold examples

## Use control measurements to estimate error

targeted measurements of a small number of taxa
