...
## Use ratio-based relative-abundance analyses
...
<!-- TODO: Add paragraph: Pre- versus post- extraction; linearity of DNA extraction. -->
<!-- Applies to spike-ins and targeted measurements. -->
...
<!-- If the purpose is to assess changes in the total community abundance rather than individual species, we recommend researchers either directly measure total abundance or, if using reference species, then explicitly acknowledge that their results are contingent on constant or at least non-systematically varying mean efficiency. -->
<!-- In the second case, confidence in the results can be bolstered by a bias-sensitivity analysis. -->
...
Empirical evidence supports this, as qPCR measurements of total 16S copies are rarely equivalent to total cell counts, even when multiple copy numbers are taken into account ()@lloyd2013meta).
