...
The high efficiency of the pathogen typically leads to a roughly 6X increase in the mean efficiency of post-colonization samples; this increase would tend to lead to a concomitant 6X decrease in the fold changes in genome copies.

TODO:

- Give numerical e.g. for the lowest eff species, Penicillium
...
- to show that variation within women is lower, compute standard deviation of log mena efficiency within women and average this (perhaps weighted by n)
...
We split the samples into groups with low and high Shannon diversity in the observed (uncorrected) community composition, leaving out samples with medium diversity, and performed a DA analysis of species proportion versus diversity group.
...
The mean efficiency tended to be larger in the high-diversity group (presumably due to a lower proportion of Lactobacillus, CHECK); unsurprisingly, the effect of bias was therefore always to lower the regression coefficient.
...
The absolute error due to bias is the same for all species in the simple linear regression (see previous section), but for the other two methods varied substantially among species (though was always positive, corresponding to the decrease in log mean efficiency in the high-diversity group).
