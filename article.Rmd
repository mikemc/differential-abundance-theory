...
**Absolute abundances are more relevant for certain biological questions such as...**
<!-- TODO: Give sentence or two motivating the measurement of absolute abundances -->
This concern has led to a recent rise in methods for supplementing MGS measurements to allow inference of absolute abundances.
<!-- Cite various approaches -->
The most popular approach is to multiply the proportions from MGS by an independent measurement of total microbial abundance.
<!-- studies to cite using this approach: in environmental microbiology (Props2017, Kevorkian2018, Lloyd2020) but also increasingly in human microbiome studies (TettamantiBoshier2020,Contijoch2019,Vandeputte2017,Vieira-Silva2019). -->
Multiplying inaccurate proportions by a measurement of cell concentration results in inaccurate absolute abundances that are subject to the same limitations on the accuracy of fold changes as standard MGS proportions alone.
