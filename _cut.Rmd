...
# Stuff that might go in an appendix with model details

### Leveraging information about a reference species

A common application of this approach involves adding a 'spike-in' in a known (and typically constant) abundance across samples (@stammler2016adju, @ji2019quan, @tkacz2018abso, @harrison2021theq, @rao2021mult).
