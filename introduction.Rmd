...
Using theoretical arguments and analysis of real and simulated experiments, we show that taxonomic bias can create error in DA results that is sufficient to lead to scientifically erroneous conclusions.
This error, however, varies by experimental context and analysis method.
