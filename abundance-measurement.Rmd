...
svg_path <- "figures/illustrations/error-proportions.svg"
...
As in the case of proportions (Equation \@ref()), the error depends on sample composition through the two mean efficiency terms and so may vary across samples.
