...
A demonstration in artificially constructed ('mock') communities of bacterial cells is shown in [Figure 3D](https://doi.org/10.7554/eLife.46923.004) of @mclaren2019cons.
...
Despite the diversity of these methods, each can be represented by Equation (\#eq:density-ratio-meas), making it straightforward to understand the impact of taxonomic bias in the MGS measurement.
