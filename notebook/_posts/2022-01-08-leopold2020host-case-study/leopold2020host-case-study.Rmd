...
I will recompute the mean efficiency with these new compositions; however, 
aero replacement will have a minimal impact on the mean efficiency. 
...
```{r infection-lfc-estimates, fig.dim = c(8, 8)}
z %>%
  filter(term == 'timepoint2') %>%
  mutate(
