...
```{theorem, label = "regression-linearity", name = "Linearity of regression coefficients", echo = TRUE}
...
```{theorem, label = "regression-error", echo = TRUE, name = "Error in regression coefficients"}
Suppose that $y$ is some response variable in nature, $z$ is our imperfect measurement of $y$, and $d = z - y$ the difference between the two, so that $z =  y + d$.
...
```{corollary, label = "regression-error-simple", echo = TRUE}
