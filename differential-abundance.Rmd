...
(In contrast to proportion-based estimates) Becuase consistent taxonomic bias creates a consistent error in ratio-based estimates, the error completely cancels, leaving accurate fold changes.
...
\begin{align}
  ...
  \cdot
  \frac{\cancel{\text{efficiency}_{i}(t)}/\cancel{\text{efficiency}_{j}(t)}} {\cancel{\text{efficiency}_{i}(s)}/\cancel{\text{efficiency}_{j}(s)}}
  \\[0.5ex]&= 
...
<details><summary style="font-weight:bold;font-size:120%">Details: Taxonomic bias and differential-abundance estimates</summary>
::: {#details:differential .rmdnote}
